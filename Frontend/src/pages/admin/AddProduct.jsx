...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-pink-50 to-purple-50 flex items-start justify-center p-1">
//       <motion.div
//         initial={{ opacity: 0, y: 40 }}
//         animate={{ opacity: 1, y: 0 }}
//         className="bg-white w-full max-w-2xl rounded-2xl shadow-xl p-8 relative sticky top-50"
//       >
//         {/* SUCCESS ANIMATION */}
//         <AnimatePresence>
//           {success && (
