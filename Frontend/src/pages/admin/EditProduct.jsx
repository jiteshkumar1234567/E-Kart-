...
//   return (
//     <div className="pt-28 max-w-3xl mx-auto bg-white p-6 rounded-xl shadow">
//       <h2 className="text-xl font-bold mb-4">Edit Product</h2>

//       <form onSubmit={handleSubmit} className="space-y-4">
//         <input name="productName" value={form.productName} onChange={handleChange} className="w-full border p-2 rounded" placeholder="Product Name" />
//         <input name="productPrice" value={form.productPrice} onChange={handleChange} className="w-full border p-2 rounded" placeholder="Price" />
//         <input name="category" value={form.category} onChange={handleChange} className="w-full border p-2 rounded" placeholder="Category" />
//         <input name="brand" value={form.brand} onChange={handleChange} className="w-full border p-2 rounded" placeholder="Brand" />

//         <input type="file" multiple onChange={handleImageChange} />

//         <div className="flex gap-2">
//           {existingImages.map((img, i) => (
//             <img key={i} src={img.url} className="w-16 h-16 rounded" />
//           ))}
//         </div>
