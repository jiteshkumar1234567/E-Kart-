...
// import { ShoppingCart, Check, Minus, Plus, ShieldCheck, Truck } from "lucide-react";
...
//   if (loading)
//     return <div className="pt-32 text-center text-lg">Loading product...</div>;
...
//              WithOut Inclusive of all taxes
//             </span>
//           </div>
...
//             onClick={addToCart}
//             disabled={added}
//             className={`w-full flex items-center justify-center gap-3 py-3 rounded-xl text-lg font-semibold transition-all
//               ${
//                 added
...
//     <span className="text-sm">100% Secure & Encrypted Payments</span>
//   </div>
...
//   <div className="flex items-center gap-3 text-gray-600">
//     <ShoppingCart className="text-pink-600" size={18} />
//     <span className="text-sm">Easy Returns & Hassle-Free Refunds</span>
//   </div>

//   <div className="flex items-center gap-3 text-gray-600">
//     <Check className="text-purple-600" size={18} />
//     <span className="text-sm">Quality Checked & Verified Products</span>
//   </div>
//           </div>
